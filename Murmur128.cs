namespace System.Security.Cryptography
{
    ...
    /// </summary>
    /// <remarks>
    /// Murmur 3 is not cryptographically secure, instead it is used for content identification.
    /// source: https://gist.github.com/jcdickinson/4bda826eb2e3f58e38c4
    /// </remarks>
    public sealed class Murmur128 : HashAlgorithm
    {
        ...
        public override int InputBlockSize => InputBlockSizeBytes;

        /// <summary>
        /// Gets the output block size.
        /// </summary>
        /// <returns>The output block size.</returns>
        public override int OutputBlockSize => InputBlockSizeBytes;
        ...
        /// </value>
        public long Seed => unchecked((long)_seed);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Murmur128"/> class.
        /// </summary>
        public Murmur128()
            : this(0)
        { }
        ...
        /// <summary>
        /// Creates an instance of the default implementation of <see cref="Murmur128"/>.
        /// </summary>
        /// <returns>A new instance of <see cref="Murmur128"/>.</returns>
        public new static Murmur128 Create()
        {
            // TODO: X86/X64.
